...
'''
1st Method Integrated with Forensics
By: Demarco Guajardo
'''
...
'''
2nd Method Integrated with Forensics
By: Demarco Guajardo
'''
...
'''
3rd Method Integrated with Forensics
By: Demarco Guajardo
'''
def scanForResourceLimits(path_scrpt):
    logger.info("SARIF result added for line: {}".format(line)) # Log (1)
    dic, lis   = {}, []
    if ( parser.checkIfValidK8SYaml( path_scrpt )  ): 
        logger.info("Valid Kubernetes YAML detected: {}".format(path_scrpt))  # Log (2)
        cnt = 0 
